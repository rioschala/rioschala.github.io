...
1. **Basic Python Syntax and Data Structures**  
   To reach this solution, you need to understand the [fundamentals of Python](/posts/inputsOutputs/), how to declare variables, write loops and conditionals, and manage data in lists and dictionaries.  
